...
Atlas::Codec<iostream>* Atlas::Net::StreamConnect::GetCodec()
{
    if (! outCodecs.empty ())
    {
        return (Atlas::Codec<iostream>*)(*outCodecs.begin())->New((void*)&Codec<iostream>::Parameters(socket,bridge));
    }
...
void Atlas::Net::StreamConnect::processServerCodecs()
{
	...
	FactoryCodecs *myCodecs = &Factory::Factories("codec");
...
void Atlas::Net::StreamConnect::processServerFilters()
{
	...
	FactoryFilters *myFilters = &Factory::Factories("filter");
